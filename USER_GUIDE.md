...
Important: NOVA is an academic decision-support system.It does not replace formal lender underwriting, legal advice, or an official credit decision.
...
Select Analyze Application.

Enter the financial and applicant information.

Select Analyze Mortgage Application.

Review the prediction, probabilities, risk indicators, financial analysis, and recommendations.
...
Enter a new mortgage application and receive a complete prediction.

Model Performance

Review the scientific evaluation of the final Machine Learning model.

Data Insights

Explore interactive patterns and distributions in the processed HMDA dataset.

Model Feedback

Record a verified real-world outcome for monitoring and controlled future retraining.

About NOVA

Review the project objective, architecture, technologies, capabilities, and limitations.
...
Elevated affordability concern
...
Strength of the model's approval signal

Debt Management

Applicant's DTI position

Equity Position

Applicant's LTV and property-equity position
...
Ability to support the requested mortgage
...
Correctly identified denial

True Approved

Correctly identified approval

False Approved

Denied case predicted as approved

False Denied

Approved case predicted as denied
...
From the Results page, select Submit Verified Outcome, or open Model Feedback from the home page.

Review the current prediction.

Select the verified actual outcome:

Approved

Denied

Confirm that the outcome is verified.

Add an optional reviewer note.

Select Submit Verified Feedback.
...
B.Sc. Information SystemsData Science SpecializationFinal Capstone Project
